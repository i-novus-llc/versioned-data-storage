...
import static ru.i_novus.platform.versioned_data_storage.pg_impl.util.StorageUtils.toSchemaName;
import static ru.i_novus.platform.versioned_data_storage.pg_impl.util.StorageUtils.toTableName;
...
public class DataDaoImpl implements DataDao {
    ...
    public List<RowValue> getData(DataCriteria criteria) {
        ...
        final String schemaName = getSchemaName(toSchemaName(criteria.getStorageCode()));
